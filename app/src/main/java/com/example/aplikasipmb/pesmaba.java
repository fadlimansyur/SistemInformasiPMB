...
public class pesmaba extends AppCompatActivity {
    WebView webViewku;

    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pesmaba);
        ...
        webViewku.loadUrl("https://id.wikipedia.org/wiki/Universitas_Muhammadiyah_Malang");
